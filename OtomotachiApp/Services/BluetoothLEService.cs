using OtomotachiApp.Uuids;

namespace OtomotachiApp.Services;

public class BluetoothLEService
{
    public BLEDeviceCandidate NewDeviceCandidateFromHomePage { get; set; } = new();
    public List<BLEDeviceCandidate> DeviceCandidateList { get; private set; }
    ...
    {
        DeviceCandidateList = new List<BLEDeviceCandidate>();
        ...
        try
        {
            ...
            {
                BLEDeviceCandidate deviceCandidate = DeviceCandidateList.FirstOrDefault(d => d.Id == systemDevice.Id);
                if (deviceCandidate == null)
                {
                    DeviceCandidateList.Add(new BLEDeviceCandidate
                    {
                        Id = systemDevice.Id,
    ...
    {
        BLEDeviceCandidate deviceCandidate = DeviceCandidateList.FirstOrDefault(d => d.Id == e.Device.Id);
        if (deviceCandidate == null)
        {
            DeviceCandidateList.Add(new BLEDeviceCandidate
            {
